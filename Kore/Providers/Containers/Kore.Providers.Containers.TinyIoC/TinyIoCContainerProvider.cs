// ***********************************************************************
// <copyright file="TinyIoCContainerProvider.cs" company="Holotrek">
...
namespace Kore.Providers.Containers
{
    /// <summary>
    /// The Unity container provider.
    /// </summary>
    /// <seealso cref="Kore.Providers.Containers.IContainerProvider" />
    public class TinyIoCContainerProvider : IContainerProvider
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TinyIoCContainerProvider" /> class.
        /// </summary>
        /// <param name="container">The container.</param>
        public TinyIoCContainerProvider(TinyIoCContainer container)
        {
