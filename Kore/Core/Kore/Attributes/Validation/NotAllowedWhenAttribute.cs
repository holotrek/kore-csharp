// ***********************************************************************
// <copyright file="NotAllowedWhenAttribute.cs" company="Holotrek">
...
{
    /// <summary>
    /// Validates that the annotated property is not specified when some other property is a defined value.
    /// </summary>
    /// <seealso cref="Kore.Attributes.Validation.DualPropertyAttributeBase" />
    public class NotAllowedWhenAttribute : DualPropertyAttributeBase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="NotAllowedWhenAttribute" /> class.
        /// </summary>
        public NotAllowedWhenAttribute()
            : base("NotAllowedWhen")
        {
        }
