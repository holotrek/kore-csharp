// ***********************************************************************
// <copyright file="MustBeGreaterThanAttribute.cs" company="Holotrek">
...
namespace Kore.Attributes.Validation
{
    ...
    public class MustBeGreaterThanAttribute : DualPropertyAttributeBase
    {
        #region Constructors
        ...
        /// </summary>
        public MustBeGreaterThanAttribute()
            : base("MustBeGreaterThan")
        {
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            if (validationContext.ObjectInstance != null)
            {
                ...
                if (thisVal == null)
                {
                    // If this value is null, then it can not possibly be greater
                    passed = otherPropValue != null;
                }
                else if (otherPropValue == null)
                {
                    // Assuming null is always lesser than something, if this value is not null (which it has to be, due to above if statement) it will be "greater"
                    passed = true;
                }
                else
                {
