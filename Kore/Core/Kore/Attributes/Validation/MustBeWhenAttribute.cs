// ***********************************************************************
// <copyright file="MustBeWhenAttribute.cs" company="Holotrek">
...
namespace Kore.Attributes.Validation
{
    ...
    public class MustBeWhenAttribute : DualPropertyAttributeBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MustBeWhenAttribute" /> class.
        /// </summary>
        public MustBeWhenAttribute()
            : base("MustBeWhen")
        {
        }
