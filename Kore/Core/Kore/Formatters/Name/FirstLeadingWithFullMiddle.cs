// ***********************************************************************
// <copyright file="FirstLeadingWithFullMiddle.cs" company="Holotrek">
...
{
    /// <summary>
    /// A full name formatter that returns a name in the format "First Middle Last".
    /// </summary>
    /// <seealso cref="Kore.Formatters.Name.IFullNameFormatter" />
    public class FirstLeadingWithFullMiddle : IFullNameFormatter
    {
        /// <summary>
        ...
        {
            return string.Format("{0}{1} {2}", firstName, string.IsNullOrWhiteSpace(middleName) ? string.Empty : " " + middleName, lastName);
        }
    }
}
