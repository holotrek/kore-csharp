// ***********************************************************************
// <copyright file="FirstLeadingWithNoMiddle.cs" company="Holotrek">
...
{
    /// <summary>
    /// A full name formatter that returns a name in the format "First Last".
    /// </summary>
    /// <seealso cref="Kore.Formatters.Name.IFullNameFormatter" />
    public class FirstLeadingWithNoMiddle : IFullNameFormatter
    {
        /// <summary>
