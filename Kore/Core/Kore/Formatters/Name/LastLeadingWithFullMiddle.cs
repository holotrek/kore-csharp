// ***********************************************************************
// <copyright file="LastLeadingWithFullMiddle.cs" company="Holotrek">
...
namespace Kore.Formatters
{
    ...
    public class LastLeadingWithFullMiddle : IFullNameFormatter
    {
        ...
        {
            return string.Format("{0}, {1}{2}", lastName, firstName, string.IsNullOrWhiteSpace(middleName) ? string.Empty : " " + middleName);
        }
    }
}
