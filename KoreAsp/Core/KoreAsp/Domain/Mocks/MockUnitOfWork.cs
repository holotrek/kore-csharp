...
namespace KoreAsp.Domain.Tests
{
    /// <summary>
    /// An implementation of Unit of Work that can be used in tests.
    /// </summary>
    /// <seealso cref="KoreAsp.Domain.Context.BaseUnitOfWork" />
    /// <seealso cref="KoreAsp.Domain.Context.IUnitOfWork{KoreAsp.Domain.Tests.MockRepository}" />
