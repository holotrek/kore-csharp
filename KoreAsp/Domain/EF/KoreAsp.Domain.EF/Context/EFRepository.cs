...
namespace KoreAsp.Domain.EF.Context
{
    /// <summary>
    ...
    /// <summary>
    /// A base EF implementation of the <see cref="KoreAsp.Domain.Context.IRepository" />.
    /// </summary>
    /// <typeparam name="TContext">The type of the Entity Framework context.</typeparam>
    /// <seealso cref="KoreAsp.Domain.EF.Context.EFRepository" />
