...
namespace KoreAsp.Providers.Serialization.Newtonsoft
{
    /// <summary>
    /// An implementation of the <see cref="KoreAsp.Providers.Serialization.ISerializationProvider" />
    /// that utilizes the NEWTONSOFT JSON library.
    /// </summary>
    /// <seealso cref="KoreAsp.Providers.Serialization.ISerializationProvider" />
